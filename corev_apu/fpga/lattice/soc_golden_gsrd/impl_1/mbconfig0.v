...
//
// Verilog Description of module mbconfig0
...
module mbconfig0 (pclk_i, rstn_i, apb_penable_i, apb_psel_i, apb_pwrite_i, 
            apb_paddr_i, apb_pwdata_i, apb_pready_o, apb_pslverr_o, 
            apb_prdata_o, config_active) /* synthesis ORIG_MODULE_NAME="mbconfig0", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    input pclk_i;
    input rstn_i;
    input apb_penable_i;
    input apb_psel_i;
