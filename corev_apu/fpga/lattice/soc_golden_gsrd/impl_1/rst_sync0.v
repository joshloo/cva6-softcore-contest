...
// Netlist written on Wed Sep 18 11:45:52 2024
...
//
// Verilog Description of module rst_sync0
// module wrapper written out since it is a black-box. 
//

//

module rst_sync0 (clk, pb_in_n, pb_out) /* synthesis ORIG_MODULE_NAME="rst_sync0", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    input clk;
    input pb_in_n;
    output pb_out;
