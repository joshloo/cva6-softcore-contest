            ...
            begin : gen_arb_gt2_req
                ...
                if (ONEHOTPRIO) 
                    begin : gen_onehot_prio
                        ...
                        //-- Sequential block --
                        //--------------------------------------------
                        always//--always @(posedge clk or negedge rst_n)--
                            @(posedge clk or 
                                negedge rst_n)
                            begin
                                if ((~rst_n)) 
...
module ahbl0_ipgen_lscc_ahbl_multiplexor #(parameter M_ADDR_WIDTH = 32, 
            ...
            begin : outreg_mstr_off
                always// always @ *
                    ...
                    begin
                        ...
                        for (i = 0 ; (i < TOTAL_SLAVE_CNT) ; i = (i + 1))// for (i = 0; i < TOTAL_SLAVE_CNT; i = i + 1) 
                            begin
    ...
    always
        ...
        begin
            ...
            hready_data_phase = (|(ahbl_hreadyout_mstr_i & ahbl_hsel_dec_r)) ;
        ...
        if (((TOTAL_MASTER_CNT > 1) && (TOTAL_SLAVE_CNT >= 1))) 
            begin : ahbl_lite_crossbar
                ...
                ahbl0_ipgen_lscc_ahbl_crossbar #(.TOTAL_MASTER_CNT(TOTAL_MASTER_CNT),
                        ...
                        .S31_MAX_BURST_SIZE(S31_MAX_BURST_SIZE)) u_lscc_ahbl_crossbar (/*AUTOINSTPARAM*/ // Parameters
                        //       .K                               (K),
                        /*AUTOINST*/ // Outputs
                        .ahbl_hreadyout_slv_o(ahbl_hreadyout_slv_o), 
                            .ahbl_hresp_slv_o(ahbl_hresp_slv_o), 
