...
module cpu0 (clk_i, 
    ...
    assign system_resetn_o = reset_n_o;
//    assign rst_w           = ~reset_n_o;
		
	// FIXME: Trial to extend the reset of CPU for more cyles after system reset
	wire [15:0] max_rst_cnt = 16'h000F;
	reg  [15:0] rst_count_r;
	reg         rst_r0;
	reg         rst_r1;
    ...
    always @(posedge clk_i or negedge rst_n_i) begin
      if (rst_n_i == 0) begin 
		...
		if (rst_count_r < max_rst_cnt) begin
          rst_count_r <= rst_count_r + 'h1;
		  rst_r0      <= 1'b1;
		end
		else 
		  rst_r0      <= 1'b0;
    ...
    VexRiscv i_cpu (
        .timerInterrupt        (1'b0),
        .externalInterrupt     (irq0_i),
        .softwareInterrupt     (1'b0),
        .iBusAhbLite3_HADDR    (ahbl_m_instr_haddr_o[31:0] ),
        .iBusAhbLite3_HWRITE   (ahbl_m_instr_hwrite_o      ),
        .iBusAhbLite3_HSIZE    (ahbl_m_instr_hsize_o[2:0]  ),
        .iBusAhbLite3_HBURST   (ahbl_m_instr_hburst_o[2:0] ),
        .iBusAhbLite3_HPROT    (ahbl_m_instr_hprot_o[3:0]  ),
        .iBusAhbLite3_HTRANS   (ahbl_m_instr_htrans_o[1:0] ),
        .iBusAhbLite3_HMASTLOCK(ahbl_m_instr_hmastlock_o   ),
        .iBusAhbLite3_HWDATA   (ahbl_m_instr_hwdata_o[31:0]),
        .iBusAhbLite3_HRDATA   (ahbl_m_instr_hrdata_i[31:0]),
        .iBusAhbLite3_HREADY   (ahbl_m_instr_hready_i      ),
        .iBusAhbLite3_HRESP    (ahbl_m_instr_hresp_i       ),
        .dBusAhbLite3_HADDR    (ahbl_m_data_haddr_o[31:0]  ),
        .dBusAhbLite3_HWRITE   (ahbl_m_data_hwrite_o       ),
        .dBusAhbLite3_HSIZE    (ahbl_m_data_hsize_o[2:0]   ),
        .dBusAhbLite3_HBURST   (ahbl_m_data_hburst_o[2:0]  ),
        .dBusAhbLite3_HPROT    (ahbl_m_data_hprot_o[3:0]   ),
        .dBusAhbLite3_HTRANS   (ahbl_m_data_htrans_o[1:0]  ),
        .dBusAhbLite3_HMASTLOCK(ahbl_m_data_hmastlock_o    ),
        .dBusAhbLite3_HWDATA   (ahbl_m_data_hwdata_o[31:0] ),
        .dBusAhbLite3_HRDATA   (ahbl_m_data_hrdata_i[31:0] ),
        .dBusAhbLite3_HREADY   (ahbl_m_data_hready_i       ),
        .dBusAhbLite3_HRESP    (ahbl_m_data_hresp_i        ),
        .clk                   (clk_i  ),
        .reset                 (rst_w  ));
endmodule

`ifndef DDRPHY_VEXRISCV
`define DDRPHY_VEXRISCV
...
module VexRiscv (
  ...
  wire [11:0] _zz_185_;
  wire [11:0] _zz_186_;
  wire [31:0] _zz_187_ /* synthesis syn_keep=1 */;
  wire [31:0] _zz_188_ /* synthesis syn_keep=1 */;
  wire [31:0] _zz_189_;
  wire [31:0] _zz_190_;
  wire [31:0] _zz_191_;
  wire [31:0] _zz_192_;
  ...
  `endif
  //
  //reg [31:0] RegFilePlugin_regFile [0:31] /* synthesis -ramstyle block_ram */ ;
  //
  (* syn_ramstyle="distributed" *) reg [31:0] RegFilePlugin_regFile [0:31];// = {32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0,32'h0};
  assign _zz_139_ = ((execute_arbitration_isValid && execute_LightShifterPlugin_isShift) && (execute_SRC2[4 : 0] != (5'b00000)));
  assign _zz_140_ = (execute_arbitration_isValid && execute_IS_CSR);
  assign _zz_141_ = (! execute_arbitration_isStuckByOthers);
  assign _zz_142_ = (CsrPlugin_hadException || CsrPlugin_interruptJump);
  assign _zz_143_ = (writeBack_arbitration_isValid && (writeBack_ENV_CTRL == `EnvCtrlEnum_defaultEncoding_XRET));
  assign _zz_144_ = writeBack_INSTRUCTION[29 : 28];
  ...
  assign _zz_151_ = ((dBus_cmd_valid && (! dBus_cmd_payload_wr)) && _zz_136_);
  assign _zz_152_ = (CsrPlugin_mstatus_MIE || (CsrPlugin_privilege < (2'b11)));
  assign _zz_153_ = ((_zz_131_ && 1'b1) && (! 1'b0));
  assign _zz_154_ = ((_zz_132_ && 1'b1) && (! 1'b0));
  assign _zz_155_ = ((_zz_133_ && 1'b1) && (! 1'b0));
  assign _zz_156_ = writeBack_INSTRUCTION[13 : 12];
  assign _zz_157_ = execute_INSTRUCTION[13];
  assign _zz_158_ = (_zz_75_ & (~ _zz_159_));
  assign _zz_159_ = (_zz_75_ - (2'b01));
  ...
  assign _zz_171_ = _zz_94_[0 : 0];
  assign _zz_172_ = _zz_94_[1 : 1];
  assign _zz_173_ = _zz_94_[2 : 2];
  assign _zz_174_ = _zz_94_[3 : 3];
  assign _zz_175_ = _zz_94_[6 : 6];
  assign _zz_176_ = _zz_94_[7 : 7];
  assign _zz_177_ = _zz_94_[8 : 8];
  assign _zz_178_ = _zz_94_[13 : 13];
  assign _zz_179_ = _zz_94_[14 : 14];
  assign _zz_180_ = _zz_94_[16 : 16];
  assign _zz_181_ = _zz_94_[19 : 19];
  assign _zz_182_ = execute_SRC_LESS;
  assign _zz_183_ = (3'b100);
  assign _zz_184_ = decode_INSTRUCTION[19 : 15];
  assign _zz_185_ = decode_INSTRUCTION[31 : 20];
  assign _zz_186_ = {decode_INSTRUCTION[31 : 25],decode_INSTRUCTION[11 : 7]};
  assign _zz_187_ = ($signed(_zz_188_) + $signed(_zz_191_));
  assign _zz_188_ = ($signed(_zz_189_) + $signed(_zz_190_));
  assign _zz_189_ = execute_SRC1;
  assign _zz_190_ = (execute_SRC_USE_SUB_LESS ? (~ execute_SRC2) : execute_SRC2);
  assign _zz_191_ = (execute_SRC_USE_SUB_LESS ? _zz_192_ : _zz_193_);
  assign _zz_192_ = (32'b00000000000000000000000000000001);
  assign _zz_193_ = (32'b00000000000000000000000000000000);
  ...
  assign _zz_205_ = dBus_cmd_payload_size;
  assign _zz_206_ = 1'b1;
  assign _zz_207_ = 1'b1;
  assign _zz_208_ = (32'b00000000000000000011000001010000);
  assign _zz_209_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000000100)) == (32'b00000000000000000110000000000000));
  assign _zz_210_ = ((decode_INSTRUCTION & (32'b00000000000000000101000000000100)) == (32'b00000000000000000100000000000000));
  assign _zz_211_ = {(_zz_216_ == _zz_217_),_zz_99_};
  assign _zz_212_ = (2'b00);
  assign _zz_213_ = ({_zz_218_,_zz_99_} != (2'b00));
  assign _zz_214_ = ({_zz_219_,_zz_220_} != (2'b00));
  assign _zz_215_ = {(_zz_221_ != _zz_222_),{_zz_223_,{_zz_224_,_zz_225_}}};
  assign _zz_216_ = (decode_INSTRUCTION & (32'b00000000000000000000000000010100));
  assign _zz_217_ = (32'b00000000000000000000000000000100);
  assign _zz_218_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001000100)) == (32'b00000000000000000000000000000100));
  assign _zz_219_ = ((decode_INSTRUCTION & _zz_226_) == (32'b00000000000000000000000000100100));
  assign _zz_220_ = ((decode_INSTRUCTION & _zz_227_) == (32'b00000000000000000001000000010000));
  assign _zz_221_ = ((decode_INSTRUCTION & _zz_228_) == (32'b00000000000000000101000000010000));
  assign _zz_222_ = (1'b0);
  assign _zz_223_ = ({_zz_229_,_zz_230_} != (2'b00));
  assign _zz_224_ = (_zz_96_ != (1'b0));
  assign _zz_225_ = {(_zz_231_ != _zz_232_),{_zz_233_,{_zz_234_,_zz_235_}}};
  assign _zz_226_ = (32'b00000000000000000000000001100100);
  assign _zz_227_ = (32'b00000000000000000011000001010100);
  assign _zz_228_ = (32'b00000000000000000111000001010100);
  assign _zz_229_ = ((decode_INSTRUCTION & (32'b01000000000000000011000001010100)) == (32'b01000000000000000001000000010000));
  assign _zz_230_ = ((decode_INSTRUCTION & (32'b00000000000000000111000001010100)) == (32'b00000000000000000001000000010000));
  assign _zz_231_ = {(_zz_236_ == _zz_237_),(_zz_238_ == _zz_239_)};
  assign _zz_232_ = (2'b00);
  assign _zz_233_ = ({_zz_240_,_zz_241_} != (2'b00));
  assign _zz_234_ = ({_zz_242_,_zz_243_} != (3'b000));
  assign _zz_235_ = {(_zz_244_ != _zz_245_),{_zz_246_,{_zz_247_,_zz_248_}}};
  assign _zz_236_ = (decode_INSTRUCTION & (32'b00000000000000000000000001010000));
  assign _zz_237_ = (32'b00000000000000000000000001000000);
  assign _zz_238_ = (decode_INSTRUCTION & (32'b00000000000000000011000001000000));
  assign _zz_239_ = (32'b00000000000000000000000001000000);
  assign _zz_240_ = ((decode_INSTRUCTION & (32'b00000000000000000001000001010000)) == (32'b00000000000000000001000001010000));
  assign _zz_241_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001010000)) == (32'b00000000000000000010000001010000));
  assign _zz_242_ = ((decode_INSTRUCTION & _zz_249_) == (32'b00000000000000000000000001000000));
  assign _zz_243_ = {(_zz_250_ == _zz_251_),(_zz_252_ == _zz_253_)};
  assign _zz_244_ = ((decode_INSTRUCTION & _zz_254_) == (32'b00000000000000000001000000000000));
  assign _zz_245_ = (1'b0);
  assign _zz_246_ = ((_zz_255_ == _zz_256_) != (1'b0));
  assign _zz_247_ = ({_zz_257_,_zz_258_} != (2'b00));
  assign _zz_248_ = {(_zz_259_ != _zz_260_),{_zz_261_,{_zz_262_,_zz_263_}}};
  assign _zz_249_ = (32'b00000000000000000000000001000100);
  assign _zz_250_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010100));
  assign _zz_251_ = (32'b00000000000000000010000000010000);
  assign _zz_252_ = (decode_INSTRUCTION & (32'b01000000000000000100000000110100));
  assign _zz_253_ = (32'b01000000000000000000000000110000);
  assign _zz_254_ = (32'b00000000000000000001000000000000);
  assign _zz_255_ = (decode_INSTRUCTION & (32'b00000000000000000011000000000000));
  assign _zz_256_ = (32'b00000000000000000010000000000000);
  assign _zz_257_ = _zz_98_;
  assign _zz_258_ = ((decode_INSTRUCTION & _zz_264_) == (32'b00000000000000000000000000100000));
  assign _zz_259_ = {_zz_98_,(_zz_265_ == _zz_266_)};
  assign _zz_260_ = (2'b00);
  assign _zz_261_ = ({_zz_267_,_zz_268_} != (2'b00));
  assign _zz_262_ = (_zz_269_ != (1'b0));
  assign _zz_263_ = {(_zz_270_ != _zz_271_),{_zz_272_,{_zz_273_,_zz_274_}}};
  assign _zz_264_ = (32'b00000000000000000000000001110000);
  assign _zz_265_ = (decode_INSTRUCTION & (32'b00000000000000000000000000100000));
  assign _zz_266_ = (32'b00000000000000000000000000000000);
  assign _zz_267_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010000)) == (32'b00000000000000000010000000000000));
  assign _zz_268_ = ((decode_INSTRUCTION & (32'b00000000000000000101000000000000)) == (32'b00000000000000000001000000000000));
  ...
  assign _zz_272_ = ({_zz_97_,_zz_279_} != (2'b00));
  assign _zz_273_ = (_zz_280_ != (1'b0));
  assign _zz_274_ = {(_zz_281_ != _zz_282_),{_zz_283_,{_zz_284_,_zz_285_}}};
  ...
  assign _zz_279_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011100)) == (32'b00000000000000000000000000000100));
  assign _zz_280_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000001000000));
  ...
  assign _zz_283_ = (((decode_INSTRUCTION & _zz_286_) == (32'b00000000000000000000000000000000)) != (1'b0));
  assign _zz_284_ = ({_zz_97_,{_zz_287_,_zz_288_}} != (6'b000000));
  assign _zz_285_ = ({_zz_289_,{_zz_290_,_zz_291_}} != (4'b0000));
  assign _zz_286_ = (32'b00000000000000000000000001011000);
  assign _zz_287_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000010000)) == (32'b00000000000000000001000000010000));
  assign _zz_288_ = {((decode_INSTRUCTION & (32'b00000000000000000010000000010000)) == (32'b00000000000000000010000000010000)),{_zz_96_,{(_zz_292_ == _zz_293_),(_zz_294_ == _zz_295_)}}};
  assign _zz_289_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001000100)) == (32'b00000000000000000000000000000000));
  assign _zz_290_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011000)) == (32'b00000000000000000000000000000000));
  assign _zz_291_ = {_zz_95_,((decode_INSTRUCTION & (32'b00000000000000000101000000000100)) == (32'b00000000000000000001000000000000))};
  assign _zz_292_ = (decode_INSTRUCTION & (32'b00000000000000000000000000001100));
  assign _zz_293_ = (32'b00000000000000000000000000000100);
  assign _zz_294_ = (decode_INSTRUCTION & (32'b00000000000000000000000000101000));
  ...
  always @(*) begin
    case(_zz_101_)
      `Src2CtrlEnum_defaultEncoding_RS : _zz_101__string = "RS ";
      `Src2CtrlEnum_defaultEncoding_IMI : _zz_101__string = "IMI";
      `Src2CtrlEnum_defaultEncoding_IMS : _zz_101__string = "IMS";
      `Src2CtrlEnum_defaultEncoding_PC : _zz_101__string = "PC ";
  ...
  assign decode_SRC2_FORCE_ZERO = _zz_40_;
  ...
  assign _zz_33_ = decode_PC;
  assign _zz_34_ = decode_RS2;
  assign decode_SRC2_CTRL = _zz_35_;
  assign _zz_37_ = decode_RS1;
  assign decode_SRC1_CTRL = _zz_38_;
  ...
  always @ (*) begin
    ...
    if((decode_arbitration_isValid && (_zz_116_ || _zz_117_)))begin
  ...
  assign _zz_95_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000000100)) == (32'b00000000000000000010000000000000));
  assign _zz_96_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001010000)) == (32'b00000000000000000000000000010000));
  assign _zz_97_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001001000)) == (32'b00000000000000000000000001001000));
  assign _zz_98_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000000100)) == (32'b00000000000000000000000000000100));
  assign _zz_99_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001010000)) == (32'b00000000000000000100000001010000));
  assign _zz_94_ = {(((decode_INSTRUCTION & _zz_208_) == (32'b00000000000000000000000001010000)) != (1'b0)),{({_zz_209_,_zz_210_} != (2'b00)),{(_zz_95_ != (1'b0)),{(_zz_211_ != _zz_212_),{_zz_213_,{_zz_214_,_zz_215_}}}}}};
  assign _zz_66_ = _zz_171_[0];
  assign _zz_65_ = _zz_172_[0];
  assign _zz_64_ = _zz_173_[0];
  assign _zz_63_ = _zz_174_[0];
  assign _zz_100_ = _zz_94_[5 : 4];
  assign _zz_62_ = _zz_100_;
  assign _zz_61_ = _zz_175_[0];
  assign _zz_60_ = _zz_176_[0];
  assign _zz_59_ = _zz_177_[0];
  assign _zz_101_ = _zz_94_[10 : 9];
  assign _zz_58_ = _zz_101_;
  assign _zz_102_ = _zz_94_[12 : 11];
  assign _zz_57_ = _zz_102_;
  assign _zz_56_ = _zz_178_[0];
  assign _zz_55_ = _zz_179_[0];
  assign _zz_54_ = _zz_180_[0];
  assign _zz_103_ = _zz_94_[18 : 17];
  assign _zz_53_ = _zz_103_;
  assign _zz_52_ = _zz_181_[0];
  assign _zz_104_ = _zz_94_[21 : 20];
  assign _zz_51_ = _zz_104_;
  assign _zz_105_ = _zz_94_[23 : 22];
  assign _zz_50_ = _zz_105_;
  assign _zz_106_ = _zz_94_[24 : 24];
  assign _zz_49_ = _zz_106_;
  ...
  assign _zz_42_ = _zz_108_;
  assign _zz_40_ = (decode_SRC_ADD_ZERO && (! decode_SRC_USE_SUB_LESS));
  always @ (*) begin
    case(decode_SRC1_CTRL)
      ...
      `Src1CtrlEnum_defaultEncoding_PC_INCREMENT : begin
        _zz_109_ = {29'd0, _zz_183_};
      end
      `Src1CtrlEnum_defaultEncoding_IMU : begin
        _zz_109_ = {decode_INSTRUCTION[31 : 12],(12'b000000000000)};
      end
      default : begin
        _zz_109_ = {27'd0, _zz_184_};
      end
    endcase
  end

  assign _zz_39_ = _zz_109_;
  ...
  always @ (*) begin
    case(decode_SRC2_CTRL)
      ...
      `Src2CtrlEnum_defaultEncoding_IMI : begin
        _zz_114_ = {_zz_111_,decode_INSTRUCTION[31 : 20]};
      end
      `Src2CtrlEnum_defaultEncoding_IMS : begin
        _zz_114_ = {_zz_113_,{decode_INSTRUCTION[31 : 25],decode_INSTRUCTION[11 : 7]}};
      end
      default : begin
        _zz_114_ = _zz_33_;
      end
  ...
  assign _zz_36_ = _zz_114_;
  always @ (*) begin
    execute_SrcPlugin_addSub = _zz_187_;
  ...
  always @ (*) begin
    _zz_116_ = 1'b0;
    if(_zz_119_)begin
      if((_zz_120_ == decode_INSTRUCTION[19 : 15]))begin
        _zz_116_ = 1'b1;
      end
    end
    if(_zz_145_)begin
  ...
  always @ (*) begin
    _zz_117_ = 1'b0;
    if(_zz_119_)begin
      if((_zz_120_ == decode_INSTRUCTION[24 : 20]))begin
        _zz_117_ = 1'b1;
      end
    end
    if(_zz_145_)begin
  ...
  assign _zz_118_ = (_zz_45_ && writeBack_arbitration_isFiring);
  ...
  assign _zz_38_ = _zz_51_;
  assign _zz_35_ = _zz_58_;
  ...
  assign iBus_rsp_valid = (iBusAhbLite3_HREADY && _zz_134_);
  ...
  assign dBusAhbLite3_HSIZE = {1'd0, _zz_205_};
  assign dBusAhbLite3_HBURST = (3'b000);
  assign dBusAhbLite3_HPROT = (4'b0001);
  always @ (*) begin
  ...
  assign dBus_rsp_ready = (dBusAhbLite3_HREADY && _zz_135_);
  ...
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      ...
      execute_CsrPlugin_wfiWake <= ({_zz_133_,{_zz_132_,_zz_131_}} != (3'b000));
      if((! writeBack_arbitration_isStuck))begin
      ...
      if(dBusAhbLite3_HREADY)begin
        _zz_136_ <= ((dBusAhbLite3_HTRANS == (2'b10)) && dBusAhbLite3_HWRITE);
      end
    end
  end
