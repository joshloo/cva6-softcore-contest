...
module apb0 (apb_pclk_i,
        apb_presetn_i,
        apb_m10_pready_mstr_i,
        apb_m10_pslverr_mstr_i,
        apb_m10_prdata_mstr_i,
        apb_m10_psel_mstr_o,
        apb_m10_paddr_mstr_o,
        apb_m10_pwrite_mstr_o,
        apb_m10_pwdata_mstr_o,
        apb_m10_penable_mstr_o,
        apb_m09_pready_mstr_i,
        apb_m09_pslverr_mstr_i,
        apb_m09_prdata_mstr_i,
        apb_m09_psel_mstr_o,
        apb_m09_paddr_mstr_o,
        apb_m09_pwrite_mstr_o,
        apb_m09_pwdata_mstr_o,
        apb_m09_penable_mstr_o,
        apb_m08_pready_mstr_i,
        apb_m08_pslverr_mstr_i,
        apb_m08_prdata_mstr_i,
        apb_m08_psel_mstr_o,
        apb_m08_paddr_mstr_o,
        apb_m08_pwrite_mstr_o,
        apb_m08_pwdata_mstr_o,
        apb_m08_penable_mstr_o,
        apb_m07_pready_mstr_i,
        apb_m07_pslverr_mstr_i,
        apb_m07_prdata_mstr_i,
        apb_m07_psel_mstr_o,
        apb_m07_paddr_mstr_o,
        apb_m07_pwrite_mstr_o,
        apb_m07_pwdata_mstr_o,
        apb_m07_penable_mstr_o,
        apb_m06_pready_mstr_i,
        apb_m06_pslverr_mstr_i,
        apb_m06_prdata_mstr_i,
        apb_m06_psel_mstr_o,
        apb_m06_paddr_mstr_o,
        apb_m06_pwrite_mstr_o,
        apb_m06_pwdata_mstr_o,
        apb_m06_penable_mstr_o,
        apb_m05_pready_mstr_i,
        apb_m05_pslverr_mstr_i,
        apb_m05_prdata_mstr_i,
        apb_m05_psel_mstr_o,
        apb_m05_paddr_mstr_o,
        apb_m05_pwrite_mstr_o,
        apb_m05_pwdata_mstr_o,
        apb_m05_penable_mstr_o,
    ...
    input apb_pclk_i ;
    input apb_presetn_i ;
    input [0:0] apb_m10_pready_mstr_i ;
    input [0:0] apb_m10_pslverr_mstr_i ;
    input [31:0] apb_m10_prdata_mstr_i ;
    output reg [0:0] apb_m10_psel_mstr_o ;
    output reg [13:0] apb_m10_paddr_mstr_o ;
    output reg [0:0] apb_m10_pwrite_mstr_o ;
    output reg [31:0] apb_m10_pwdata_mstr_o ;
    output reg [0:0] apb_m10_penable_mstr_o ;
    input [0:0] apb_m09_pready_mstr_i ;
    input [0:0] apb_m09_pslverr_mstr_i ;
    input [31:0] apb_m09_prdata_mstr_i ;
    output reg [0:0] apb_m09_psel_mstr_o ;
    output reg [13:0] apb_m09_paddr_mstr_o ;
    output reg [0:0] apb_m09_pwrite_mstr_o ;
    output reg [31:0] apb_m09_pwdata_mstr_o ;
    output reg [0:0] apb_m09_penable_mstr_o ;
    input [0:0] apb_m08_pready_mstr_i ;
    input [0:0] apb_m08_pslverr_mstr_i ;
    input [31:0] apb_m08_prdata_mstr_i ;
    output reg [0:0] apb_m08_psel_mstr_o ;
    output reg [13:0] apb_m08_paddr_mstr_o ;
    output reg [0:0] apb_m08_pwrite_mstr_o ;
    output reg [31:0] apb_m08_pwdata_mstr_o ;
    output reg [0:0] apb_m08_penable_mstr_o ;
    input [0:0] apb_m07_pready_mstr_i ;
    input [0:0] apb_m07_pslverr_mstr_i ;
    input [31:0] apb_m07_prdata_mstr_i ;
    output reg [0:0] apb_m07_psel_mstr_o ;
    output reg [13:0] apb_m07_paddr_mstr_o ;
    output reg [0:0] apb_m07_pwrite_mstr_o ;
    output reg [31:0] apb_m07_pwdata_mstr_o ;
    output reg [0:0] apb_m07_penable_mstr_o ;
    input [0:0] apb_m06_pready_mstr_i ;
    input [0:0] apb_m06_pslverr_mstr_i ;
    input [31:0] apb_m06_prdata_mstr_i ;
    output reg [0:0] apb_m06_psel_mstr_o ;
    output reg [13:0] apb_m06_paddr_mstr_o ;
    output reg [0:0] apb_m06_pwrite_mstr_o ;
    output reg [31:0] apb_m06_pwdata_mstr_o ;
    output reg [0:0] apb_m06_penable_mstr_o ;
    input [0:0] apb_m05_pready_mstr_i ;
    input [0:0] apb_m05_pslverr_mstr_i ;
    input [31:0] apb_m05_prdata_mstr_i ;
    output reg [0:0] apb_m05_psel_mstr_o ;
    output reg [13:0] apb_m05_paddr_mstr_o ;
    output reg [0:0] apb_m05_pwrite_mstr_o ;
    output reg [31:0] apb_m05_pwdata_mstr_o ;
    output reg [0:0] apb_m05_penable_mstr_o ;
    input [0:0] apb_m04_pready_mstr_i ;
    input [0:0] apb_m04_pslverr_mstr_i ;
    input [31:0] apb_m04_prdata_mstr_i ;
    output reg [0:0] apb_m04_psel_mstr_o ;
    output reg [13:0] apb_m04_paddr_mstr_o ;
    output reg [0:0] apb_m04_pwrite_mstr_o ;
    output reg [31:0] apb_m04_pwdata_mstr_o ;
    output reg [0:0] apb_m04_penable_mstr_o ;
    input [0:0] apb_m03_pready_mstr_i ;
    input [0:0] apb_m03_pslverr_mstr_i ;
    input [31:0] apb_m03_prdata_mstr_i ;
    output reg [0:0] apb_m03_psel_mstr_o ;
    output reg [13:0] apb_m03_paddr_mstr_o ;
    output reg [0:0] apb_m03_pwrite_mstr_o ;
    output reg [31:0] apb_m03_pwdata_mstr_o ;
    output reg [0:0] apb_m03_penable_mstr_o ;
    input [0:0] apb_m02_pready_mstr_i ;
    input [0:0] apb_m02_pslverr_mstr_i ;
    input [31:0] apb_m02_prdata_mstr_i ;
    output reg [0:0] apb_m02_psel_mstr_o ;
    output reg [13:0] apb_m02_paddr_mstr_o ;
    output reg [0:0] apb_m02_pwrite_mstr_o ;
    output reg [31:0] apb_m02_pwdata_mstr_o ;
    output reg [0:0] apb_m02_penable_mstr_o ;
    input [0:0] apb_m01_pready_mstr_i ;
    input [0:0] apb_m01_pslverr_mstr_i ;
    input [31:0] apb_m01_prdata_mstr_i ;
    output reg [0:0] apb_m01_psel_mstr_o ;
    output reg [13:0] apb_m01_paddr_mstr_o ;
    output reg [0:0] apb_m01_pwrite_mstr_o ;
    output reg [31:0] apb_m01_pwdata_mstr_o ;
    output reg [0:0] apb_m01_penable_mstr_o ;
    input [0:0] apb_s00_psel_slv_i ;
    input [13:0] apb_s00_paddr_slv_i ;
    input [0:0] apb_s00_pwrite_slv_i ;
    input [31:0] apb_s00_pwdata_slv_i ;
    input [0:0] apb_s00_penable_slv_i ;
    output reg [0:0] apb_s00_pready_slv_o ;
    output reg [0:0] apb_s00_pslverr_slv_o ;
    output reg [31:0] apb_s00_prdata_slv_o ;
    input [0:0] apb_m00_pready_mstr_i ;
    input [0:0] apb_m00_pslverr_mstr_i ;
    input [31:0] apb_m00_prdata_mstr_i ;
    output reg [0:0] apb_m00_psel_mstr_o ;
    output reg [13:0] apb_m00_paddr_mstr_o ;
    output reg [0:0] apb_m00_pwrite_mstr_o ;
    output reg [31:0] apb_m00_pwdata_mstr_o ;
    output reg [0:0] apb_m00_penable_mstr_o ;
    parameter M_ADDR_WIDTH = 14 ;
    parameter FULL_DECODE_EN = 1 ;
    parameter TOTAL_TRAGEN_AXI = 1 ;
    parameter S0_BASE_ADDR = 14'h0000 ;
    parameter S0_ADDR_RANGE = 14'h0400 ;
    parameter S1_BASE_ADDR = 14'h0400 ;
    parameter S1_ADDR_RANGE = 14'h0400 ;
    parameter S2_BASE_ADDR = 14'h0800 ;
    parameter S2_ADDR_RANGE = 14'h0400 ;
    parameter S3_BASE_ADDR = 14'h0c00 ;
    parameter S3_ADDR_RANGE = 14'h0400 ;
    parameter S4_BASE_ADDR = 14'h1000 ;
    parameter S4_ADDR_RANGE = 14'h0400 ;
    parameter S5_BASE_ADDR = 14'h1400 ;
    parameter S5_ADDR_RANGE = 14'h0400 ;
    parameter S6_BASE_ADDR = 14'h1800 ;
    parameter S6_ADDR_RANGE = 14'h0400 ;
    parameter S7_BASE_ADDR = 14'h1c00 ;
    parameter S7_ADDR_RANGE = 14'h0400 ;
    parameter S8_BASE_ADDR = 14'h2000 ;
    parameter S8_ADDR_RANGE = 14'h0400 ;
    parameter S9_BASE_ADDR = 14'h2400 ;
    parameter S9_ADDR_RANGE = 14'h0400 ;
    parameter S10_BASE_ADDR = 14'h2800 ;
    parameter S10_ADDR_RANGE = 14'h0400 ;

    // GPIO, UART, MC + TOTAL_TRAGEN_AXI
    localparam TOTAL_SLAVE_CNT = 3+TOTAL_TRAGEN_AXI;
    localparam MIN_NUM_TRAGEN_AXI = 2;
    wire [TOTAL_SLAVE_CNT-1:0] apb_m_pready_mstr_i ;
    wire [TOTAL_SLAVE_CNT-1:0] apb_m_pslverr_mstr_i ;
    wire [TOTAL_SLAVE_CNT*32-1:0] apb_m_prdata_mstr_i ;
    wire [TOTAL_SLAVE_CNT-1:0] apb_m_psel_mstr_o ;
    wire [TOTAL_SLAVE_CNT*M_ADDR_WIDTH-1:0] apb_m_paddr_mstr_o ;
    wire [TOTAL_SLAVE_CNT-1:0] apb_m_pwrite_mstr_o ;
    wire [TOTAL_SLAVE_CNT*32-1:0] apb_m_pwdata_mstr_o ;
    wire [TOTAL_SLAVE_CNT-1:0] apb_m_penable_mstr_o ;

    assign apb_m_pready_mstr_i = {apb_m10_pready_mstr_i[0],
                                  apb_m09_pready_mstr_i[0],
                                  apb_m08_pready_mstr_i[0],
                                  apb_m07_pready_mstr_i[0],
                                  apb_m06_pready_mstr_i[0],
                                  apb_m05_pready_mstr_i[0],
                                  apb_m04_pready_mstr_i[0],
                                  apb_m03_pready_mstr_i[0],
                                  apb_m02_pready_mstr_i[0],
                                  apb_m01_pready_mstr_i[0],
                                  apb_m00_pready_mstr_i[0]};
    assign apb_m_pslverr_mstr_i = {apb_m10_pslverr_mstr_i[0],
                                   apb_m09_pslverr_mstr_i[0],
                                   apb_m08_pslverr_mstr_i[0],
                                   apb_m07_pslverr_mstr_i[0],
                                   apb_m06_pslverr_mstr_i[0],
                                   apb_m05_pslverr_mstr_i[0],
                                   apb_m04_pslverr_mstr_i[0],
                                   apb_m03_pslverr_mstr_i[0],
                                   apb_m02_pslverr_mstr_i[0],
                                   apb_m01_pslverr_mstr_i[0],
                                   apb_m00_pslverr_mstr_i[0]};
    assign apb_m_prdata_mstr_i = {apb_m10_prdata_mstr_i[31:0],
                                  apb_m09_prdata_mstr_i[31:0],
                                  apb_m08_prdata_mstr_i[31:0],
                                  apb_m07_prdata_mstr_i[31:0],
                                  apb_m06_prdata_mstr_i[31:0],
                                  apb_m05_prdata_mstr_i[31:0],
                                  apb_m04_prdata_mstr_i[31:0],
                                  apb_m03_prdata_mstr_i[31:0],
                                  apb_m02_prdata_mstr_i[31:0],
                                  apb_m01_prdata_mstr_i[31:0],
                                  apb_m00_prdata_mstr_i[31:0]};

    // For ports 05:10, they may or may not be generated, depnding on
    // DUT configuration.
    always @* begin
      // We will always have 5 M ports here:
      // 1. GPIO
      // 2. UART
      // 3. MC
      // 4. Tragen0
      // 5. Tragen1
      // The MPMC will have a minimum of 2 external mgrs, hence
      // we'll always have at least 2 tragen.
      apb_m04_psel_mstr_o[0] = apb_m_psel_mstr_o[4*1 +: 1];
      apb_m03_psel_mstr_o[0] = apb_m_psel_mstr_o[3*1 +: 1];
      apb_m02_psel_mstr_o[0] = apb_m_psel_mstr_o[2*1 +: 1];
      apb_m01_psel_mstr_o[0] = apb_m_psel_mstr_o[1*1 +: 1];
      apb_m00_psel_mstr_o[0] = apb_m_psel_mstr_o[0*1 +: 1];
      apb_m04_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[4*M_ADDR_WIDTH +: M_ADDR_WIDTH];
      apb_m03_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[3*M_ADDR_WIDTH +: M_ADDR_WIDTH];
      apb_m02_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[2*M_ADDR_WIDTH +: M_ADDR_WIDTH];
      apb_m01_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[1*M_ADDR_WIDTH +: M_ADDR_WIDTH];
      apb_m00_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[0*M_ADDR_WIDTH +: M_ADDR_WIDTH];
      apb_m04_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[4*1 +: 1];
      apb_m03_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[3*1 +: 1];
      apb_m02_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[2*1 +: 1];
      apb_m01_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[1*1 +: 1];
      apb_m00_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[0*1 +: 1];
      apb_m04_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[4*32 +: 32];
      apb_m03_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[3*32 +: 32];
      apb_m02_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[2*32 +: 32];
      apb_m01_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[1*32 +: 32];
      apb_m00_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[0*32 +: 32];
      apb_m04_penable_mstr_o[0] = apb_m_penable_mstr_o[4*1 +: 1];
      apb_m03_penable_mstr_o[0] = apb_m_penable_mstr_o[3*1 +: 1];
      apb_m02_penable_mstr_o[0] = apb_m_penable_mstr_o[2*1 +: 1];
      apb_m01_penable_mstr_o[0] = apb_m_penable_mstr_o[1*1 +: 1];
      apb_m00_penable_mstr_o[0] = apb_m_penable_mstr_o[0*1 +: 1];

      // The rest will be default to 0. Only drive them when configured
      apb_m10_psel_mstr_o[0] = 1'b0;
      apb_m09_psel_mstr_o[0] = 1'b0;
      apb_m08_psel_mstr_o[0] = 1'b0;
      apb_m07_psel_mstr_o[0] = 1'b0;
      apb_m06_psel_mstr_o[0] = 1'b0;
      apb_m05_psel_mstr_o[0] = 1'b0;
      apb_m10_paddr_mstr_o[M_ADDR_WIDTH-1:0] = {M_ADDR_WIDTH{1'b0}};
      apb_m09_paddr_mstr_o[M_ADDR_WIDTH-1:0] = {M_ADDR_WIDTH{1'b0}};
      apb_m08_paddr_mstr_o[M_ADDR_WIDTH-1:0] = {M_ADDR_WIDTH{1'b0}};
      apb_m07_paddr_mstr_o[M_ADDR_WIDTH-1:0] = {M_ADDR_WIDTH{1'b0}};
      apb_m06_paddr_mstr_o[M_ADDR_WIDTH-1:0] = {M_ADDR_WIDTH{1'b0}};
      apb_m05_paddr_mstr_o[M_ADDR_WIDTH-1:0] = {M_ADDR_WIDTH{1'b0}};
      apb_m10_pwrite_mstr_o[0] = 1'b0;
      apb_m09_pwrite_mstr_o[0] = 1'b0;
      apb_m08_pwrite_mstr_o[0] = 1'b0;
      apb_m07_pwrite_mstr_o[0] = 1'b0;
      apb_m06_pwrite_mstr_o[0] = 1'b0;
      apb_m05_pwrite_mstr_o[0] = 1'b0;
      apb_m10_pwdata_mstr_o[31:0] = {32{1'b0}};
      apb_m09_pwdata_mstr_o[31:0] = {32{1'b0}};
      apb_m08_pwdata_mstr_o[31:0] = {32{1'b0}};
      apb_m07_pwdata_mstr_o[31:0] = {32{1'b0}};
      apb_m06_pwdata_mstr_o[31:0] = {32{1'b0}};
      apb_m05_pwdata_mstr_o[31:0] = {32{1'b0}};
      apb_m10_penable_mstr_o[0] = 1'b0;
      apb_m09_penable_mstr_o[0] = 1'b0;
      apb_m08_penable_mstr_o[0] = 1'b0;
      apb_m07_penable_mstr_o[0] = 1'b0;
      apb_m06_penable_mstr_o[0] = 1'b0;
      apb_m05_penable_mstr_o[0] = 1'b0;

      if(TOTAL_TRAGEN_AXI>=3) begin
        apb_m05_psel_mstr_o[0] = apb_m_psel_mstr_o[5*1 +: 1];
        apb_m05_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[5*M_ADDR_WIDTH +: M_ADDR_WIDTH];
        apb_m05_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[5*1 +: 1];
        apb_m05_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[5*32 +: 32];
        apb_m05_penable_mstr_o[0] = apb_m_penable_mstr_o[5*1 +: 1];
      end

      if(TOTAL_TRAGEN_AXI>=4) begin
        apb_m06_psel_mstr_o[0] = apb_m_psel_mstr_o[6*1 +: 1];
        apb_m06_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[6*M_ADDR_WIDTH +: M_ADDR_WIDTH];
        apb_m06_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[6*1 +: 1];
        apb_m06_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[6*32 +: 32];
        apb_m06_penable_mstr_o[0] = apb_m_penable_mstr_o[6*1 +: 1];
      end


      if(TOTAL_TRAGEN_AXI>=5) begin
        apb_m07_psel_mstr_o[0] = apb_m_psel_mstr_o[7*1 +: 1];
        apb_m07_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[7*M_ADDR_WIDTH +: M_ADDR_WIDTH];
        apb_m07_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[7*1 +: 1];
        apb_m07_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[7*32 +: 32];
        apb_m07_penable_mstr_o[0] = apb_m_penable_mstr_o[7*1 +: 1];
      end

      if(TOTAL_TRAGEN_AXI>=6) begin
        apb_m08_psel_mstr_o[0] = apb_m_psel_mstr_o[8*1 +: 1];
        apb_m08_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[8*M_ADDR_WIDTH +: M_ADDR_WIDTH];
        apb_m08_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[8*1 +: 1];
        apb_m08_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[8*32 +: 32];
        apb_m08_penable_mstr_o[0] = apb_m_penable_mstr_o[8*1 +: 1];
      end

      if(TOTAL_TRAGEN_AXI>=7) begin
        apb_m09_psel_mstr_o[0] = apb_m_psel_mstr_o[9*1 +: 1];
        apb_m09_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[9*M_ADDR_WIDTH +: M_ADDR_WIDTH];
        apb_m09_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[9*1 +: 1];
        apb_m09_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[9*32 +: 32];
        apb_m09_penable_mstr_o[0] = apb_m_penable_mstr_o[9*1 +: 1];
      end


      if(TOTAL_TRAGEN_AXI==8) begin
        apb_m10_psel_mstr_o[0] = apb_m_psel_mstr_o[10*1 +: 1];
        apb_m10_paddr_mstr_o[M_ADDR_WIDTH-1:0] = apb_m_paddr_mstr_o[10*M_ADDR_WIDTH +: M_ADDR_WIDTH];
        apb_m10_pwrite_mstr_o[0] = apb_m_pwrite_mstr_o[10*1 +: 1];
        apb_m10_pwdata_mstr_o[31:0] = apb_m_pwdata_mstr_o[10*32 +: 32];
        apb_m10_penable_mstr_o[0] = apb_m_penable_mstr_o[10*1 +: 1];
      end
    end
...
//            .S_ARBITER_SCHEME(3'd0),
            .S_M_PRIO_IDX(1'd1)) lscc_apb_interconnect_inst (.apb_pclk_i(apb_pclk_i),
                ...
                .apb_paddr_slv_i({apb_s00_paddr_slv_i[13:0]}),
                ...
                .apb_pready_mstr_i(apb_m_pready_mstr_i),
                .apb_pslverr_mstr_i(apb_m_pslverr_mstr_i),
                .apb_prdata_mstr_i(apb_m_prdata_mstr_i),
                .apb_psel_mstr_o(apb_m_psel_mstr_o),
                .apb_paddr_mstr_o(apb_m_paddr_mstr_o),
                .apb_pwrite_mstr_o(apb_m_pwrite_mstr_o),
                .apb_pwdata_mstr_o(apb_m_pwdata_mstr_o),
                .apb_penable_mstr_o(apb_m_penable_mstr_o)) ;
endmodule
